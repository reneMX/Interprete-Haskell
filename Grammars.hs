...
happyExpList = Happy_Data_Array.listArray (0,29) ([528,1,0,480,4129,8450,528,4129,8450,528,64,16388,1024,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","ASA","int","'+'","'-'","'*'","'/'","'('","')'","%eof"]
