...
happyExpList = Happy_Data_Array.listArray (0,47) ([1072,8,0,0,0,49566,24592,12296,6148,2,32769,256,128,4288,2144,1072,536,512,256,128,49216,24592,8,8,4,0,0,0,4288,4096,0,1024,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","ASA","var","int","'+'","'-'","'*'","'/'","'('","')'","let","lambda","%eof"]
...
action_12 (5) = happyShift action_23
action_12 _ = happyFail (happyExpListPerState 12)

action_13 (5) = happyShift action_22
...
happyReduction_8 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (Lambda happy_var_4 happy_var_5
	) `HappyStk` happyRest
